...
export async function sendAgreementEmail(partner: Recipient): Promise<EmailResult> {
  ...
  return send({
    ...
    text: `Hi ${partner.contactName},\n\nYour application to join the Apex Fleet Consulting Referral Partner Program has been approved.\n\nNext steps:\n1. Open ${portalUrl}\n2. Enter ${partner.email}.\n3. Use the secure link emailed to you.\n4. Review and electronically sign the agreement.\n5. Your referral tools unlock after signing.\n\nNo ChatGPT account is required.\n\nApex Fleet Consulting LLC`,
    html: `<div style="font-family:Arial,sans-serif;max-width:620px;margin:auto;color:#0d1f35"><p style="font-weight:700;color:#bc5a15">APEX FLEET CONSULTING LLC</p><h1>Your partner application is approved</h1><p>Hi ${escapeHtml(partner.contactName)},</p><p>Your application for <strong>${escapeHtml(partner.companyName)}</strong> has been approved. Your Referral Partner Agreement is ready for review and electronic signature.</p><ol><li>Open the secure partner portal.</li><li>Enter <strong>${escapeHtml(partner.email)}</strong>.</li><li>Use the secure link emailed to you.</li><li>Review and sign the agreement.</li><li>Your referral tools unlock after signing.</li></ol><p><strong>No ChatGPT account is required.</strong></p><p><a href="${escapeHtml(portalUrl)}" style="display:inline-block;background:#e87b2f;color:white;padding:14px 22px;text-decoration:none;border-radius:8px;font-weight:700">Access partner portal</a></p></div>`,
  });
}
